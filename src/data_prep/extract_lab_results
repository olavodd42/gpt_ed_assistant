import pandas as pd
df_master = pd.read_csv('/home/olavo-dalberto/gpt_ed_assistant/data/raw/processed/master_dataset.csv')
...
df_lab_master = pd.read_csv('/home/olavo-dalberto/gpt_ed_assistant/data/raw/hosp/labevents.csv')
df_lab_hospitalized = df_lab_master[pd.notna(df_lab_master['hadm_id'])]
df_labitems = pd.read_csv('/home/olavo-dalberto/gpt_ed_assistant/data/raw/hosp/d_labitems_labeled.csv')
#extract common labs
...
filtered_df_master_hospitalized_lab_results.to_csv("/home/olavo-dalberto/gpt_ed_assistant/data/raw/processed/master_lab_results.csv",index=False)